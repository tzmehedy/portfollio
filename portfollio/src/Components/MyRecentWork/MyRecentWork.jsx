...
const MyRecentWork = () => {
    ...
    return (
      <div className="bg-[#0F0715] py-10">
        ...
        <div className="flex justify-center gap-10 container mx-auto mt-10">
          <div
            onMouseLeave={() => setOpen(0)}
            onMouseEnter={() => setOpen(1)}
            className="w-full h-[550px]   overflow-auto p-10 bg-[#2C184D] shadow-2xl rounded-2xl border border-[#0F0715] relative"
          >
            ...
            {open === 1 && (
              <div className="w-full flex justify-center items-center ">
                <a
                  ...
                  target="_blank"
                  className="bg-[#3B1F71] w-full text-center h-20 text-white font-bold text-4xl absolute bottom-0 flex justify-evenly items-center rounded-2xl"
                >
                  Ai Mentor
